...
QT_MOC_LITERAL(7, 122, 20), // "onFeedBackFromServer"
QT_MOC_LITERAL(8, 143, 21), // "onSetUserStateClicked"
QT_MOC_LITERAL(9, 165, 7) // "onError"

    },
    "TalkingListScreen\0onFreshFriendList\0"
    "\0onAddNewFriendClicked\0onMakeMassesClicked\0"
    "onTalkingWithOtherClicked\0QListWidgetItem*\0"
    "onFeedBackFromServer\0onSetUserStateClicked\0"
    "onError"
};
...
void TalkingListScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onFeedBackFromServer(); break;
        case 5: _t->onSetUserStateClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->onError(); break;
        default: ;
        }
    }
}
