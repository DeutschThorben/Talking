...
#include "../Server/model/userlist.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UserList_t, stringdata) + ofs \
...
const QMetaObject UserList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UserList.data,
...
void *UserList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UserList.stringdata))
