...
#include "../TalkingClient/screen/addfriend.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddFriend_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddFriend_t qt_meta_stringdata_AddFriend = {
    {
QT_MOC_LITERAL(0, 0, 9), // "AddFriend"
QT_MOC_LITERAL(1, 10, 16), // "onBtnFindClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17), // "onBtnEmptyClicked"
QT_MOC_LITERAL(4, 46, 16) // "onBtnExitClicked"

    },
    "AddFriend\0onBtnFindClicked\0\0"
    "onBtnEmptyClicked\0onBtnExitClicked"
};
...
void AddFriend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onBtnFindClicked(); break;
...
void *AddFriend::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddFriend.stringdata))
